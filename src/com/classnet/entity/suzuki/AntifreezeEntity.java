...
@Entity
@Table(name="T_ANTIFREEZE")
public class AntifreezeEntity implements Serializable {
	private Integer id;
	...
	private String filling_pressure_time;
	private String filling1_high_pressure;
	private String f1hp_time;
	private String filling_pressure_leak;
	private String fpl_time;
	private String filling_volume;
	private String filling_volume_time;
	private String filling_additional_volume;
	...
	@Column(name="filling_pressure_time")
	public String getFilling_pressure_time() {
		return filling_pressure_time;
	}
	public void setFilling_pressure_time(String filling_pressure_time) {
		this.filling_pressure_time = filling_pressure_time;
	}
	@Column(name="filling1_high_pressure")
	public String getFilling1_high_pressure() {
		return filling1_high_pressure;
	}
	public void setFilling1_high_pressure(String filling1_high_pressure) {
		this.filling1_high_pressure = filling1_high_pressure;
	}
	@Column(name="f1hp_time")
	public String getF1hp_time() {
		return f1hp_time;
	}
	public void setF1hp_time(String f1hp_time) {
		this.f1hp_time = f1hp_time;
	}
	@Column(name="filling_pressure_leak")
	public String getFilling_pressure_leak() {
		return filling_pressure_leak;
	}
	public void setFilling_pressure_leak(String filling_pressure_leak) {
		this.filling_pressure_leak = filling_pressure_leak;
	}
	@Column(name="fpl_time")
	public String getFpl_time() {
		return fpl_time;
	}
	public void setFpl_time(String fpl_time) {
		this.fpl_time = fpl_time;
	}
	...
	@Column(name="filling_additional_volume")
	public String getFilling_additional_volume() {
		return filling_additional_volume;
	}
	public void setFilling_additional_volume(String filling_additional_volume) {
		this.filling_additional_volume = filling_additional_volume;
	}
