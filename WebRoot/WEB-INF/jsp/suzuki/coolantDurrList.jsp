...
function search(){
	...
	var url = "<c:url value="/suzuki/coolantDurr.do?m=list"/>";
	if(vin_code.value!=""){
...
function exportExcel(){
	...
	var mobile_unit = document.getElementById("mobile_unit");
	var filling_result = document.getElementById("filling_result");
	var url = "<c:url value="/suzuki/coolantDurr.do?m=listExcel"/>";
	if(vin_code.value!=""){
		url+="&vin_code="+vin_code.value;
	}
	if(car_type.value!=""){
	...
	<div class="wrap">
		...
		<div class="main">
			...
			<div id="instructionalResearch" class="mediumTurquoise"
				...
				<dl>
					<dt>
						<em><a href="<c:url value="#"/>">杜尔冷媒查询</a></em>
					</dt>
					...
					<div id="c01">
						...
						<table width="99%" border="0" cellpadding="0" cellspacing="1"
							...
							<tr>
								...
								<td  height="30" bgcolor="#e5edfa" align="center">超压测试</td>
								...
								<td  height="30" bgcolor="#e5edfa" align="center">时间</td>
								<td  height="30" bgcolor="#e5edfa" align="center">加注量g</td>
								<td  height="30" bgcolor="#e5edfa" align="center">时间</td>
								<td  height="30" bgcolor="#e5edfa" align="center">循环时间</td>
							</tr>
							<c:choose>
								<c:when test="${not empty coolantDurrList}">
									<c:forEach items="${coolantDurrList}" var="antifreeze" varStatus="vs">
										<tr>
											...
											<td height="30" bgcolor="#FFFFFF" align="center"> <c:out value="${antifreeze.over_pressure}" /></td>
											<td height="30" bgcolor="#FFFFFF" align="center"> <c:out value="${antifreeze.over_pressure_time}" /></td>
								...
								<c:otherwise>
									<tr>
										<td colspan="18" height="30" bgcolor="#ffffff" align="center">暂无数据</td>
									</tr>
								</c:otherwise>
							</c:choose>
						</table>
