...
function search(){
	...
	var url = "<c:url value="/suzuki/coolantYh.do?m=list"/>";
	if(vin_code.value!=""){
...
function exportExcel(){
	...
	var mobile_unit = document.getElementById("mobile_unit");
	var filling_result = document.getElementById("filling_result");
	var url = "<c:url value="/suzuki/coolantYh.do?m=listExcel"/>";
	if(vin_code.value!=""){
		url+="&vin_code="+vin_code.value;
	}
	if(car_type.value!=""){
	...
	<div class="wrap">
		...
		<div class="main">
			...
			<div id="instructionalResearch" class="mediumTurquoise"
				...
				<dl>
					<dt>
						<em><a href="<c:url value="#"/>">易恒冷媒查询</a></em>
					</dt>
					...
					<div id="c01">
						...
						<table width="99%" border="0" cellpadding="0" cellspacing="1"
							...
							<tr>
								...
								<td  height="30" bgcolor="#e5edfa" align="center">时间</td>
								<td  height="30" bgcolor="#e5edfa" align="center">真空值</td>
								<td  height="30" bgcolor="#e5edfa" align="center">时间</td>
							...
							<c:choose>
								<c:when test="${not empty coolantYhList}">
									<c:forEach items="${coolantYhList}" var="antifreeze" varStatus="vs">
										<tr>
