...
function search(){
	...
	var url = "<c:url value="/suzuki/brakeFluidYh.do?m=list"/>";
	if(vin_code.value!=""){
...
function exportExcel(){
	...
	var mobile_unit = document.getElementById("mobile_unit");
	var filling_result = document.getElementById("filling_result");
	var url = "<c:url value="/suzuki/brakeFluidYh.do?m=listExcel"/>";
	if(vin_code.value!=""){
		url+="&vin_code="+vin_code.value;
	}
	if(car_type.value!=""){
	...
	<div class="wrap">
		...
		<div class="main">
			...
			<div id="instructionalResearch" class="mediumTurquoise"
				...
				<dl>
					<dt>
						<em><a href="<c:url value="#"/>">易恒刹车油查询</a></em>
					</dt>
					...
					<div id="c01">
						...
						<table width="99%" border="0" cellpadding="0" cellspacing="1"
							...
							<tr>
								...
								<td  height="30" bgcolor="#e5edfa" align="center">时间</td>
								<td  height="30" bgcolor="#e5edfa" align="center">最终真空值</td>
								<td  height="30" bgcolor="#e5edfa" align="center">时间</td>
								<td  height="30" bgcolor="#e5edfa" align="center">加注压力</td>
								<td  height="30" bgcolor="#e5edfa" align="center">加注量L</td>
								<td  height="30" bgcolor="#e5edfa" align="center">时间</td>
								<td  height="30" bgcolor="#e5edfa" align="center">循环时间</td>
							</tr>
							<c:choose>
								<c:when test="${not empty brakeFluidYhList}">
									<c:forEach items="${brakeFluidYhList}" var="antifreeze" varStatus="vs">
										<tr>
								...
								<c:otherwise>
									<tr>
										<td colspan="17" height="30" bgcolor="#ffffff" align="center">暂无数据</td>
									</tr>
								</c:otherwise>
							</c:choose>
						</table>
